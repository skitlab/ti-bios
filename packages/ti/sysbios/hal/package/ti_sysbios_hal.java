...
public class ti_sysbios_hal
{
    ...
    {
        // module Core
        om.bind("ti.sysbios.hal.Core.getId", new Extern("ti_sysbios_hal_Core_getId__E", "xdc_UInt(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.hal.Core.interruptCore", new Extern("ti_sysbios_hal_Core_interruptCore__E", "xdc_Void(*)(xdc_UInt)", true, false));
        om.bind("ti.sysbios.hal.Core.lock", new Extern("ti_sysbios_hal_Core_lock__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.hal.Core.unlock", new Extern("ti_sysbios_hal_Core_unlock__E", "xdc_Void(*)(xdc_Void)", true, false));
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.a64',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.a430',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.a430X',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.a430XS',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.aer4te',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.aer4fte',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.hal.aa15g',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.hal.aa15g', {target: 'gnu.targets.arm.A15', suffix: 'a15g'}],\n");
    ...
    void Core$$SINGLETONS()
    {
        ...
        vo.bind("getId", om.findStrict("ti.sysbios.hal.Core.getId", "ti.sysbios.hal"));
        vo.bind("interruptCore", om.findStrict("ti.sysbios.hal.Core.interruptCore", "ti.sysbios.hal"));
        vo.bind("lock", om.findStrict("ti.sysbios.hal.Core.lock", "ti.sysbios.hal"));
        vo.bind("unlock", om.findStrict("ti.sysbios.hal.Core.unlock", "ti.sysbios.hal"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_hal_Core_Module__startupDone__E", "ti_sysbios_hal_Core_getId__E", "ti_sysbios_hal_Core_interruptCore__E", "ti_sysbios_hal_Core_lock__E", "ti_sysbios_hal_Core_unlock__E", "ti_sysbios_hal_Core_hwiDisable__E", "ti_sysbios_hal_Core_hwiEnable__E", "ti_sysbios_hal_Core_hwiRestore__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");

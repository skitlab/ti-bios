...
/* getId__E */
#define ti_sysbios_hal_Core_getId ti_sysbios_hal_Core_getId__E
xdc__CODESECT(ti_sysbios_hal_Core_getId__E, "ti_sysbios_hal_Core_getId")
__extern xdc_UInt ti_sysbios_hal_Core_getId__E( void );
xdc__CODESECT(ti_sysbios_hal_Core_getId__F, "ti_sysbios_hal_Core_getId")
__extern xdc_UInt ti_sysbios_hal_Core_getId__F( void );
__extern xdc_UInt ti_sysbios_hal_Core_getId__R( void );

/* interruptCore__E */
#define ti_sysbios_hal_Core_interruptCore ti_sysbios_hal_Core_interruptCore__E
xdc__CODESECT(ti_sysbios_hal_Core_interruptCore__E, "ti_sysbios_hal_Core_interruptCore")
__extern xdc_Void ti_sysbios_hal_Core_interruptCore__E( xdc_UInt coreId );
xdc__CODESECT(ti_sysbios_hal_Core_interruptCore__F, "ti_sysbios_hal_Core_interruptCore")
__extern xdc_Void ti_sysbios_hal_Core_interruptCore__F( xdc_UInt coreId );
__extern xdc_Void ti_sysbios_hal_Core_interruptCore__R( xdc_UInt coreId );

/* lock__E */
#define ti_sysbios_hal_Core_lock ti_sysbios_hal_Core_lock__E
xdc__CODESECT(ti_sysbios_hal_Core_lock__E, "ti_sysbios_hal_Core_lock")
__extern xdc_Void ti_sysbios_hal_Core_lock__E( void );
xdc__CODESECT(ti_sysbios_hal_Core_lock__F, "ti_sysbios_hal_Core_lock")
__extern xdc_Void ti_sysbios_hal_Core_lock__F( void );
__extern xdc_Void ti_sysbios_hal_Core_lock__R( void );

/* unlock__E */
#define ti_sysbios_hal_Core_unlock ti_sysbios_hal_Core_unlock__E
xdc__CODESECT(ti_sysbios_hal_Core_unlock__E, "ti_sysbios_hal_Core_unlock")
__extern xdc_Void ti_sysbios_hal_Core_unlock__E( void );
xdc__CODESECT(ti_sysbios_hal_Core_unlock__F, "ti_sysbios_hal_Core_unlock")
__extern xdc_Void ti_sysbios_hal_Core_unlock__F( void );
__extern xdc_Void ti_sysbios_hal_Core_unlock__R( void );

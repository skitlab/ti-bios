...
#define ti_sysbios_smp_LoggerBuf_TimestampProxy___VERS 150
...
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

...
public class ti_sysbios_knl
{
    ...
    void Task$$SIZES()
    {
        ...
        sizes.add(Global.newArray("smpCurQ", "UPtr"));
    ...
    void Task$$TYPES()
    {
        ...
        po.init("ti.sysbios.knl.Task.Module_State", null);
                ...
                po.addFld("smpCurQ", new Proto.Arr((Proto)om.findStrict("ti.sysbios.knl.Queue.Handle", "ti.sysbios.knl"), false), $$DEFAULT, "w");
    ...
    void Task$$ROV()
    {
        ...
        po.bind("smpCurQ$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_Ptr", "isScalar", true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.a64',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.a430',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.a430X',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.a430XS',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.aer4te',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.aer4fte',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.knl.aa15g',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.a64', {target: 'ti.targets.C64', suffix: '64'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.a430', {target: 'ti.targets.msp430.MSP430', suffix: '430'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.a430X', {target: 'ti.targets.msp430.MSP430X', suffix: '430X'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.a430XS', {target: 'ti.targets.msp430.MSP430X_small', suffix: '430XS'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.knl.aa15g', {target: 'gnu.targets.arm.A15', suffix: 'a15g'}],\n");
    ...
    void Semaphore$$SINGLETONS()
    {
        ...
        vo.bind("$$logEvtCfgs", Global.newArray("LM_post", "LM_pend"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_noEvents", "A_invTimeout", "A_badContext", "A_overflow"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.seal("length");
    ...
    void Task$$SINGLETONS()
    {
        ...
        vo.bind("$$assertDescCfgs", Global.newArray("A_badThreadType", "A_badTaskState", "A_noPendElem", "A_taskDisabled", "A_badPriority", "A_badTimeout", "A_badAffinity"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.setElem("", true);
        atmap.setElem("", true);
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.sysbios.knl.Task", "ti.sysbios.knl");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Basic", Global.newObject("type", om.find("xdc.rov.ViewInfo.INSTANCE"), "viewInitFxn", "viewInitBasic", "structName", "BasicView")}), Global.newArray(new Object[]{"Detailed", Global.newObject("type", om.find("xdc.rov.ViewInfo.INSTANCE"), "viewInitFxn", "viewInitDetailed", "structName", "DetailedView")}), Global.newArray(new Object[]{"Module", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE"), "viewInitFxn", "viewInitModule", "structName", "ModuleView")}), Global.newArray(new Object[]{"ReadyQs", Global.newObject("type", om.find("xdc.rov.ViewInfo.TREE_TABLE"), "viewInitFxn", "viewInitReadyQs", "structName", "ReadyQView")})}))));
        }//isCFG

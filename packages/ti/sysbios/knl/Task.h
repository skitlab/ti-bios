...
typedef ti_sysbios_knl_Queue_Handle __T1_ti_sysbios_knl_Task_Module_State__smpCurQ;
typedef ti_sysbios_knl_Queue_Handle *__ARRAY1_ti_sysbios_knl_Task_Module_State__smpCurQ;
typedef __ARRAY1_ti_sysbios_knl_Task_Module_State__smpCurQ __TA_ti_sysbios_knl_Task_Module_State__smpCurQ;

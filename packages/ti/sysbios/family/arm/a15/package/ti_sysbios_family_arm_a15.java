...
public class ti_sysbios_family_arm_a15
{
    ...
    void Mmu$$OBJECTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", new Proto.Enm("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc"));
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.a15.Mmu$$FirstLevelDescAttrs", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", new Proto.Str(spo, false));
    ...
    void Cache$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a15.Cache.enablePmc", new Extern("ti_sysbios_family_arm_a15_Cache_enablePmc__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.resetPmc", new Extern("ti_sysbios_family_arm_a15_Cache_resetPmc__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.getPmcMiss", new Extern("ti_sysbios_family_arm_a15_Cache_getPmcMiss__E", "xdc_UInt(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.getPmcAxs", new Extern("ti_sysbios_family_arm_a15_Cache_getPmcAxs__E", "xdc_UInt(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.getPmcCycle", new Extern("ti_sysbios_family_arm_a15_Cache_getPmcCycle__E", "xdc_UInt(*)(xdc_Void)", true, false));
    ...
    {
        // module Mmu
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_FAULT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"), "ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_FAULT", xdc.services.intern.xsr.Enum.intValue(0L)+0));
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_PAGE_TABLE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"), "ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_PAGE_TABLE", xdc.services.intern.xsr.Enum.intValue(1L)+0));
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"), "ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION", xdc.services.intern.xsr.Enum.intValue(2L)+0));
        om.bind("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION_PXN", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"), "ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION_PXN", xdc.services.intern.xsr.Enum.intValue(3L)+0));
        ...
        om.bind("ti.sysbios.family.arm.a15.Mmu.initDescAttrs", new Extern("ti_sysbios_family_arm_a15_Mmu_initDescAttrs__E", "xdc_Void(*)(ti_sysbios_family_arm_a15_Mmu_FirstLevelDescAttrs*)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.a15.Mmu.setFirstLevelDesc", new Extern("ti_sysbios_family_arm_a15_Mmu_setFirstLevelDesc__E", "xdc_Void(*)(xdc_Ptr,xdc_Ptr,ti_sysbios_family_arm_a15_Mmu_FirstLevelDescAttrs*)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.a15.Mmu.initTableBuf", new Extern("ti_sysbios_family_arm_a15_Mmu_initTableBuf__I", "xdc_Void(*)(xdc_UInt32*)", true, false));
    }
    ...
    void TimestampProvider$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a15.TimestampProvider.getCCNT32", new Extern("ti_sysbios_family_arm_a15_TimestampProvider_getCCNT32__I", "xdc_UInt32(*)(xdc_Void)", true, false));
    ...
    {
        // module SysUart
        om.bind("ti.sysbios.family.arm.a15.SysUart.abort", new Extern("ti_sysbios_family_arm_a15_SysUart_abort__E", "xdc_Void(*)(xdc_String)", true, false));
    ...
    void Mmu$$FUNCTIONS()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.sysbios.family.arm.a15.Mmu$$setFirstLevelDescMeta", new Proto.Fxn(om.findStrict("ti.sysbios.family.arm.a15.Mmu.Module", "ti.sysbios.family.arm.a15"), null, 3, 3, false));
                ...
                fxn.addArg(2, "attrs", (Proto)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a15"), $$DEFAULT);
    }
    ...
    void Mmu$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a15");
        sizes.clear();
        sizes.add(Global.newArray("type", "Nti.sysbios.family.arm.a15.Mmu.FirstLevelDesc;;0;1;2;3"));
        ...
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs'], fld); }");
        so.bind("$offsetof", fxn);
    ...
    void Mmu$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("defaultAttrs", (Proto)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a15"), Global.newObject("type", om.find("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION"), "tex", 0L, "bufferable", false, "cacheable", false, "shareable", false, "noexecute", false, "imp", 1L, "domain", 0L, "accPerm", 3L), "w");
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.a15.Mmu$$FirstLevelDescAttrs", "ti.sysbios.family.arm.a15");
        po.init("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("type", (Proto)om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"), $$UNDEF, "w");
    ...
    void Mmu$$ROV()
    {
        ...
        vo.bind("FirstLevelDescAttrs$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.a15.Mmu$$FirstLevelDescAttrs", "ti.sysbios.family.arm.a15");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.a15.aa15g',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.a15.aa15g', {target: 'gnu.targets.arm.A15', suffix: 'a15g'}],\n");
        sb.append("];\n");
    ...
    void Cache$$SINGLETONS()
    {
        ...
        vo.bind("enablePmc", om.findStrict("ti.sysbios.family.arm.a15.Cache.enablePmc", "ti.sysbios.family.arm.a15"));
        vo.bind("resetPmc", om.findStrict("ti.sysbios.family.arm.a15.Cache.resetPmc", "ti.sysbios.family.arm.a15"));
        vo.bind("getPmcMiss", om.findStrict("ti.sysbios.family.arm.a15.Cache.getPmcMiss", "ti.sysbios.family.arm.a15"));
        vo.bind("getPmcAxs", om.findStrict("ti.sysbios.family.arm.a15.Cache.getPmcAxs", "ti.sysbios.family.arm.a15"));
        vo.bind("getPmcCycle", om.findStrict("ti.sysbios.family.arm.a15.Cache.getPmcCycle", "ti.sysbios.family.arm.a15"));
    ...
    void Mmu$$SINGLETONS()
    {
        ...
        vo.bind("FirstLevelDesc", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc", "ti.sysbios.family.arm.a15"));
        vo.bind("FirstLevelDescAttrs", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a15"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a15"));
        ...
        vo.bind("FirstLevelDesc_FAULT", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_FAULT", "ti.sysbios.family.arm.a15"));
        vo.bind("FirstLevelDesc_PAGE_TABLE", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_PAGE_TABLE", "ti.sysbios.family.arm.a15"));
        vo.bind("FirstLevelDesc_SECTION", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION", "ti.sysbios.family.arm.a15"));
        vo.bind("FirstLevelDesc_SECTION_PXN", om.findStrict("ti.sysbios.family.arm.a15.Mmu.FirstLevelDesc_SECTION_PXN", "ti.sysbios.family.arm.a15"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        vo.bind("initTableBuf", om.findStrict("ti.sysbios.family.arm.a15.Mmu.initTableBuf", "ti.sysbios.family.arm.a15"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_a15_Mmu_Module__startupDone__E", "ti_sysbios_family_arm_a15_Mmu_disable__E", "ti_sysbios_family_arm_a15_Mmu_enable__E", "ti_sysbios_family_arm_a15_Mmu_initDescAttrs__E", "ti_sysbios_family_arm_a15_Mmu_isEnabled__E", "ti_sysbios_family_arm_a15_Mmu_setFirstLevelDesc__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
    ...
    void TimestampProvider$$SINGLETONS()
    {
        ...
        vo.bind("getCCNT32", om.findStrict("ti.sysbios.family.arm.a15.TimestampProvider.getCCNT32", "ti.sysbios.family.arm.a15"));

...
public class ti_sysbios_timers_dmtimer
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.aa15g',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.aa15g', {target: 'gnu.targets.arm.A15', suffix: 'a15g'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
